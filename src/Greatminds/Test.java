...
public class Test {
    ...
    public static void main(String[] args) throws InterruptedException, ParseException {
       ...
       Js js =new Js();
        ...
        //Select campagin= new Select(driver.findElement(By.id("exampleFormControlSelect1")));
        //campagin.selectByValue("12087c22-260a-4fb8-834e-d231c4c277a3");// 9618db88-fc78-47a5-9916-e864e696ae11
        //campagin.selectByValue("9618db88-fc78-47a5-9916-e864e696ae11");// Euraka Math
        ...
        //jobType.selectByValue("ebd040f1-9eeb-4b83-b651-1bb44588d2ef"); // Text Quote ++D
					...
					// System.out.println("source >>>"+ elements.get(i).getText() );
					 if(i==1) {
						 ...
						 if(checkElement( followingSibling, "Show activities about Progress")) {
							 followingSibling.findElement(/*By.linkText("Show activities about Progress")*/By.partialLinkText("Progress")).click();
						 }else {
							 elements.get(i).click();
